        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Encrypted transactions and 24/7 fraud monitoring.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Verify Accounts</h3>
              <p className="text-gray-600">
                Verify your accounts to get your dedicated account number and higher limits.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-brand-green rounded-full flex items-center justify-center mx-auto mb-6 text-white text-2xl font-bold">
