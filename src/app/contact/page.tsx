...
export const metadata: Metadata = {
  ...
  description: 'Get in touch with XpderGlobal. Open a wallet, become an agent, or partner with us.',
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-green-100">
              Ready to open a wallet, become an agent, or explore a partnership? 
              We&apos;re here to help.
            </p>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="tel:+2348064197619" className="hover:text-brand-green">
                        +234 806 419 7619
                      </a>
                    </p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="mailto:expedier.inc@gmail.com" className="hover:text-brand-green">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="https://wa.me/2348064197619" className="hover:text-brand-green">
                        +234 806 419 7619
                      </a>
                    </p>
                    <p className="text-sm text-gray-500 mt-1">Quick questions? Message us</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <a href="/communities" className="text-brand-green hover:underline text-sm">
                    → Become an Agent
                  </a>
                  <a href="/partners" className="text-brand-green hover:underline text-sm">
                    → Partnership Inquiry
                  </a>
                  <a href="/compliance" className="text-brand-green hover:underline text-sm">
                    → Report an Issue
                  </a>
                  <a href="/careers" className="text-brand-green hover:underline text-sm">
                    → Future Careers
                  </a>
                </div>
              </div>
                ...
                <form className="space-y-6">
                  ...
                  <div>
                    ...
                    <select className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-green focus:border-transparent">
                      <option>Opening a wallet</option>
                  ...
                  <button
                    type="submit"
                    className="w-full bg-brand-green text-white px-6 py-3 rounded-lg font-semibold hover:bg-brand-green-dark transition-colors"
                  >
                    Send Message
                  </button>
                </form>
            ...
            <div className="inline-block bg-white rounded-xl p-6 shadow-sm">
              <div className="grid grid-cols-2 gap-8 text-left">
                <div>
                  ...
                  <p className="text-gray-600">8:00 AM - 6:00 PM WAT</p>
                </div>
                <div>
                ...
                <div>
                  <p className="font-semibold text-gray-900">Public Holidays</p>
                  <p className="text-gray-600">Closed</p>
                </div>
              </div>
            </div>
            <p className="text-sm text-gray-500 mt-4">
              For urgent issues outside office hours, WhatsApp is monitored.
            </p>
          </div>
        </div>
      </section>
